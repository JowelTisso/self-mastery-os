    ...
    <div className="pb-6 space-y-6">
      ...
      <div className="bg-gray-900 rounded-xl border border-gray-800 p-5">
        ...
        >
          ...
          <div className={`w-11 h-6 rounded-full flex items-center transition-colors ${darkMode ? 'bg-teal-500' : 'bg-gray-600'}`}>
      ...
      <div className="bg-gray-900 rounded-xl border border-gray-800 p-5">
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <div>
              <p className="text-white">Export All Logs</p>
      ...
      <button
        onClick={logout}
        className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border border-gray-800 text-gray-400 hover:bg-gray-900 transition-colors"
      >
          ...
          <div className="bg-gray-900 rounded-2xl border border-gray-800 p-6 w-full max-w-sm">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-2.5 rounded-xl bg-gray-800 text-white hover:bg-gray-700 transition-colors"
              >
                Cancel
              </button>
              <button
