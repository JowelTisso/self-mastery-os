    ...
    <div className="min-h-svh bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">Self Mastery OS</h1>
          <p className="text-gray-400 mt-2">Your personal growth operating system</p>
        </div>
        ...
        <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-11 pr-4 py-3 rounded-xl bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
                  />
                </div>
              </div>
            )}
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 rounded-xl bg-gray-800 border border-gray-700 text-white font-medium hover:bg-gray-750 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
          >
